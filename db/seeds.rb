...
ForumType.create(title: '交流區',description: '通用區')
ForumType.create(title: '團務區',description: '團內事務討論區')
ForumType.create(title: '網站事務區',description: '網站發生的疑難雜症都可在這區發問')

Forum.create(title: '活動通知子板',description: '諸如各校團慶等活動通知邀請',forum_type_id: 1,public_at: true)
Forum.create(title: '校內討論子版',description: '',forum_type_id: 2,public_at: false)
Forum.create(title: '校內幹部子版',description: '',forum_type_id: 2,public_at: false)
Forum.create(title: '團務交流子板',description: '',forum_type_id: 2,public_at: false)
Forum.create(title: '畢業夥伴子板',description: '',forum_type_id: 2,public_at: false)
Forum.create(title: '權限申請子版',description: '申請永久子板或辦理活動臨時討論子版或其他需求。',forum_type_id: 3,public_at: true)
Forum.create(title: '網站問題子板',description: '網站事務子版',forum_type_id: 3,public_at: true)
Forum.create(title: '網站事務子版',description: '',forum_type_id: 3,public_at: false)
Forum.create(title: '閒話家常子版',description: '任何主題都可聊',forum_type_id: 1,public_at: true)
